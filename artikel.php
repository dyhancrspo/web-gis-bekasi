...
<h2>Artikel dan Ulasan</h2> 
<h6 class="text-underline-primary">Segalanya tentang  Artikel dan Ulasan Kuliner di Bekasi</h6> 
</div> 
</section> 
...
<img style="min-width: 250px; min-height: 250px" src="admin/assets/uploads/pics/artikel/<?php echo $row['pic'];?>" class="img-fluid rounded"> 
</div> 
...
<p>
  <?php echo $fm->textShorten($row['isi_artikel']);?>  <br>
  <a class="btn btn-primary " href="artikel_lihat.php?id_artikel=<?php echo $row['id_artikel']; ?>">Read More</a></p> 
</div> 
</div> 
</div> 
</div> 
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="about-box text-white">
              ...
              <p>NgulinerYuk adalah sebuah Web GIS yang memberikan segala informasi yang berkaitan tentang kuliner di Kota Bekasi.</p>
            </div>
          </div>
          <div class="col-md-6">
            <h5 class="text-white">
