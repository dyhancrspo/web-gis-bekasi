    ...
    <div class="wrapper">
      ...
      <header class="main-header">      
		<nav class="navbar navbar-static-top">
            <a href="<?php echo ('http://localhost/gisbekasi/index.php'); ?>" class="logo"><?php if($this->session->userdata('nav')=='') echo $this->session->userdata('judul'); else echo "<img src='".base_url()."assets/uploads/logo/".$this->session->userdata('nav')."' />";?></a>
          ...
          <div class="collapse navbar-collapse" id="navbar-collapse">
            <?php echo form_open('front','class="navbar-form navbar-right"'); ?>
              <div class="form-group">
                <input type="text" class="form-control" name="username" placeholder="Masukkan Username" value="<?php echo set_value('username'); ?>" autofocus />
				...
				if($this->session->userdata('tema')=='skin-red') echo "btn-success";
				if($this->session->userdata('tema')=='skin-blue') echo "btn-warning";
				if($this->session->userdata('tema')=='skin-green') echo "btn-purple bg-purple";
				if($this->session->userdata('tema')=='skin-purple') echo "btn-success";
        ...
        <div class="container-fluid">
		  ...
		  <div class="col-lg-6">
			<div class="box <?php
			  ...
			  ?>"></i>
					 <h3 class="box-title">Sistem Informasi Geografis <?php echo $this->session->userdata('judul');?></h3>
                </div>
                <div class="box-body">
