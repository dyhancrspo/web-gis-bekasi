          ...
          <ul class="sidebar-menu">
            ...
            <li <?php if($this->session->userdata('option')=='dashboard') echo 'class="active"';?> >
              <a href="<?php echo base_url();?>dashboard">
                ...
                <li <?php if($this->session->userdata('option')=='user') echo 'class="active"';?>><a href="<?php echo site_url('dashboard/user')?>"><i class="fa fa-users"></i> User</a>
          </li>
               <li <?php if($this->session->userdata('option')=='artikel') echo 'class="active"';?>><a href="<?php echo site_url('dashboard/artikel')?>"><i class="fa fa-book"></i> Artikel</a>
          </li>
                <li <?php if($this->session->userdata('option')=='galleryku') echo 'class="active"';?>><a href="<?php echo site_url('dashboard/galleryku')?>"><i class="fa fa-photo"></i> Gallery</a>
          </li>
					...
					<div class="row">
						...
						<div class="col-lg-3 col-xs-6">
						  ...
						  <div class="small-box bg-blue">
							<div class="inner">
							  <h3><?php echo "Setting";//$this->session->userdata('jml_jenis');?></h3>
