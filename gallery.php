<?php
    ...
    $sql = "SELECT *  FROM setting, galleryku";
...
<html lang="en">
  <head>
    ...
    <title>Gallery - <?php echo $row['desc'];?></title>
      <link rel="stylesheet" type="text/css" href="assets/css/style.css">     
          <link rel="stylesheet" type="text/css" href="assets/css/stylefooter.css">
          <link rel="stylesheet" type="text/css" href="assets/css/style-loadingpage.css">
...
<section class="team-section py-5">
  <div class="container">
    <div class="row mb-5">
      <div class="head-box text-center mb-5 col-md-12">
        <h2> Kumpulan Gambar - Gambar Kuliner</h2>
        <h6 class="text-underline-primary mb-5">Kota Bekasi</h6>
      </div> 
  ...
  {  
?>
<div class="col-md-4 mb-md-5 mb-sm-4">
        <div class="member-box anim-bt t-bottom">
              <img style="min-width: 400px; min-height: 400px; max-width: 400px; max-height: 400px;" class="img-fluid" src="admin/assets/uploads/pics/gallery/<?= $row['picture'];?>" alt=""></a>
              <div class="overlay-content">
               <a href="admin/assets/uploads/pics/gallery/<?= $row['picture'];?>" data-lightbox="roadtrip" data-title="<?php echo $row['keterangan']?>">  <h3 class="text-white ml-3 my-0"><?php echo $row['keterangan']?>  </h3> </a>
                <p class="text-white ml-3 mb-3">Click to see Full Image</p>
                          </div>
          </div>
      </div>
...
<section class="action-sec">
          <div class="container">
            <br>
              <div class="action-box text-center"><h2><strong>Cari Tahu Yuk</h2> </strong> <h3>Dimana aja sih Kuliner - Kuliner yang enak dan lezat di Kota Bekasi</h3><a class="btn btn-theme" href="wisata.php" target="_blank" title="">Cari di Peta</a></div>
          </div>
          <br>
          <br>
      </section>
