...
<link rel="stylesheet" href="ps://cdnjs.cloudflare.com/ajax/libs/fancybox/3.3.5/jquery.fancybox.min.css" /> 
...
<h2>Artikel</h2> 
<h6 class="text-underline-primary">Lihat Artikel Kuliner</h6> 
</div> 
...
$result = mysqli_query($connection,"SELECT * FROM artikel where id_artikel = '$id'"); 
